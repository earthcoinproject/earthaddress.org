(function (translator) {
	translator.translations["pt-br"] = {
		...
		"paperlabelbitcoinaddress": "Endereço EarthCoin:",
		...
		"tagline": "Gerador local de carteiras EarthCoin usando Javascript de código aberto",
		"generatelabelbitcoinaddress": "Gerando endereço EarthCoin...",
		...
		"singlelabelbitcoinaddress": "Endereço EarthCoin",
		"singlelabelprivatekey": "Chave privada (Wallet Import Format):",
		"singletip1": "<b>Uma carteira EarthCoin</b> é tão simples quanto um simples pareamento de um endereço EarthCoin com a sua chave privada EarthCoin correspondente. Essa carteira foi gerada para você em seu navegador web e está sendo exibida acima.",
		"singletip2": "<b>Para proteger essa carteira</b> você deve imprimir ou anotar/salvar o endereço EarthCoin e a chave privada. É importante que você faça uma cópia de segurança da sua chave privada e armazene-a em um local seguro. Esse site não toma conhecimento da sua chave privada. Se você for familiar com PGP, você pode baixar essa pagina HTML tudo-em-um e verificar se você tem uma versão autêntica do autor deste site ao fazer a correspondência do hash SHA256 deste HTML com o hash SHA256 disponível na versão assinada do documento linkado no rodapé deste site. Se você sair/atualizar essa página ou apertar o botão Gerar Novo Endereço, então uma nova chave privada será gerada e a chave exibida anteriormente não será recuperável.	A sua chave privada EarthCoin deve ser mantida como um segredo. Qualquer pessoa que tiver acesso a ela poderá gastar todos os seus bitcoins associados com aquele endereço. Se você imprimir sua carteira, armazene-a em um saco plástico selado para mantê-la longe da água. Trate uma carteira em papel como se fosse dinheiro.",
		"singletip3": "<b>Adicione fundos</b> para essa carteira ao indicar para outras pessoas enviarem bitcoins para o seu endereço EarthCoin.",
		"singletip4": "<b>Verifique seu saldo</b> visitando os sites blockchain.info ou blockexplorer.com e digitando o seu endereço EarthCoin.",
		...
		"brainlabelbitcoinaddress": "Enderçeo EarthCoin:",
		...
		"vanitylabelbitcoinaddress": "Endereço EarthCoin Vanity:",
		...
		"detaillabelnote2": "As versões do EarthCoin acima da v0.6+ armazenam as chaves públicas comprimidas. O cliente também suporta a importação/exportação de chaves privadas usando importprivkey/dumpprivkey. O formato das chaves privadas exportadas depende se o endereço foi gerado em uma carteira antiga ou nova.",
		"detaillabelbitcoinaddress": "Endereço EarthCoin:",
		"detaillabelbitcoinaddresscomp": "Endereço EarthCoin (comprimido):",
